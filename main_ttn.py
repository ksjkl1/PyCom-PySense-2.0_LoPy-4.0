...
def join_lora(force_join = False):
    ...
    if not lora.has_joined() or force_join == True:
        ...
        app_eui = ubinascii.unhexlify('XXXXXX7ED003BE2D')
        app_key = ubinascii.unhexlify('XXXXXXC474E43113E1E79C64DD1835DF')
        dev_eui = ubinascii.unhexlify('XXXXXX4990286DB7')
        print("app_eui = XXXXXX7ED003BE2D")
        print("app_key = XXXXXXC474E43113E1E79C64DD1835DF")
        print("dev_eui = XXXXXX4990286DB7")
