...
def join_lora(force_join = False):
    ...
    if not lora.has_joined() or force_join == True:
        ...
        #app_eui = ubinascii.unhexlify('70B3D57ED003BE2D')
        #app_key = ubinascii.unhexlify('A15FEDC474E43113E1E79C64DD1835DF')
        #dev_eui = ubinascii.unhexlify('70B3D54990286DB7')
        #print("app_eui = 70B3D57ED003BE2D")
        #print("app_key = A15FEDC474E43113E1E79C64DD1835DF")
